...
class Login(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        entry_bg_1 = self.canvas.create_image(
            736.0, 331.0, image=entry_image_1)
        ...
        entry_bg_2 = self.canvas.create_image(
            736.0, 229.0, image=entry_image_2)
        ...
        entry_bg_3 = self.canvas.create_image(
            736.0, 241.0, image=entry_image_3)
        self.username = Entry(
            self.canvas,
            bd=0,
            bg="#EFEFEF",
        ...
        entry_bg_4 = self.canvas.create_image(
            736.0, 342.0, image=entry_image_4)
        self.password = Entry(
            self.canvas,
            bd=0,
            bg="#EFEFEF",
